<?php
    function insertarActividad($titulo, $ubicacion, $ubicacion_url, $dificultad, $epoca, $desnivel, $distancia, $duracion, $descripcion, $foto_1, $foto_2, $publicada){
        global $conexion;
        ...
        $stmt->bind_param("ssssssdssssi", $titulo, $ubicacion, $ubicacion_url, $dificultad, $epoca, $desnivel, $distancia, $duracion, $descripcion, $foto_1, $foto_2, $publicada); 
        $stmt->execute();
