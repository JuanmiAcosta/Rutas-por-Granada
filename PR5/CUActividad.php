<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($metodo == "crear"){
            ...
            || $bonus2 == null || $url_iframe == null || $publicada == null){
            ...
            $id_act = insertarActividad($titulo, $ubicacion, $ubicacion_url, $dificultad, $epoca, $desnivel, $distancia, $duracion, $descripcion, $foto_1, $foto_2, $publicada);
            ...
            && $descripcion == null && $publicada == null){
                header("Location: /actividad/" . $id_act);
                exit();
             }
            ...
            if ($publicada == null){
                $publicada = 0;
                $atributos['publicada'] = $publicada;
            }else if ($publicada != null){
                $atributos['publicada'] = $publicada;
            }
