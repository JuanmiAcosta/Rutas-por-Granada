<?php
    ...
    function getActividad($idact) {
        ...
        if ($resultado->num_rows > 0) {
            ...
            'desnivel' => $desnivel, 'foto_1' => $foto_1, 'foto_2' => $foto_2, 'id' => $id);
        }
    ...
    function getActividadesPorTitulo($texto){
        ...
        if ($resultado->num_rows > 0) {
            while($actividad = $resultado->fetch_assoc()) {
                $actividades[] = array('id' => $actividad['id'], 'titulo' => $actividad['titulo'], 'foto' => $actividad['foto_1'], 'ubicacion' => $actividad['ubicacion']);
            }
        }
